<script setup>
    ...
    const sortBy = ref('publishedDate,desc')
    const limit = ref(9)
    const search = ref('')
    const page = ref(1)
                ...
                <div class="col-md-3">
                    ...
                    <div v-else>
                        <div class="mb-3">
                            ...
                            <select class="form-control" v-model="sortBy">
                                <option value="publishedDate,desc">Released Date</option>
                    ...
                    <div v-else>
                        <div class="form-check" v-for="brand in brands">
                            ...
                            <label class="form-check-label">
                                {{ brand.name }} ({{ brand.total_product }})
                            </label>
                        </div>
                                ...
                                <div class="card-body clearfix">
                                    ...
                                    <div class="float-start">
                                        <div class="ms-4">
                                            ...
                                            <small class='text-danger me-2'>$ {{ parseFloat(product.price).toFixed(2) }}</small><del><small class='text-muted'>$ {{ parseFloat(product.priceOld).toFixed(2) }}</small></del>
