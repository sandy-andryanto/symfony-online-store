                ...
                <div class="col-md-5" v-else>
                    <Form ref="form" :validation-schema="schema" @submit="submit" :initial-values="billing">
                        ...
                        <div class="mb-3">
                            ...
                            <Field  name="firstName" v-model="billing.firstName"  v-slot="{ field, errors }">
                        ...
                        <div class="mb-3">
                            ...
                            <Field  name="lastName" v-model="billing.lastName"  v-slot="{ field, errors }">
                        ...
                        <div class="mb-3">
                            ...
                            <Field  name="zipCode" v-model="billing.zipCode"  v-slot="{ field, errors }">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mb-1 p-2 mt-2">
                                ...
                                <div class="col-md-9 text-end">
                                    <h6 class='text-danger fw-bold'>$ {{ parseFloat(order.totalShipment).toFixed(2) }}</h6>
                                </div>
                            </div>
                            <div class="row mb-1 p-2 mt-2">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-9 text-end">
                                    <h6 class='text-danger fw-bold'>$ {{ parseFloat(order.totalTaxes).toFixed(2) }}</h6>
                                </div>
                            </div>
                            <div class="row mb-1 p-2 mt-2">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-9 text-end">
                                    <h6 class='text-success fw-bold'>$ {{ parseFloat(order.totalDiscount).toFixed(2) }}</h6>
                                </div>
                            </div>
                            <div class="row mb-1 p-2 mt-2">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-9 text-end">
                                    <h6 class='text-danger fw-bold'>$ {{ parseFloat(order.totalPaid).toFixed(2) }}</h6>
                                </div>
                            </div>
                            <div class="row mb-1 p-2 mt-2">
                                <div class="col-md-12">
