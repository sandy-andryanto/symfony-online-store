                    ...
                    <div v-else>
                        ...
                        <div class='clearfix mt-3 mb-1'>
                            <div class="small text-warning mb-2">
                                <i class="bi bi-star-fill" v-for="index in product.totalRating" :key="index"></i>
                                <i class="bi bi-star" v-if="product.totalRating < 5" v-for="idx in (5 - product.totalRating)" :key="idx"></i>
                            </div>
                        ...
                        <div class="tab-pane container" :class="tabActive === 2 ? 'active p-0' : ''">
                            ...
                            <div class="row mt-3" v-else>
                                <div class="col-md-3">
                                    ...
                                    <div class="clearfix mt-2">
                                        <div class="row" v-for="r in reviews">
                                            <div class="col-md-6">
                                                <div class="d-inline text-warning">
                                                    <i class="bi bi-star-fill" v-for="index in r.ratingIndex" :key="index"></i>
                                                    <i class="bi bi-star" v-if="r.ratingIndex < 5" v-for="idx in (5 - r.ratingIndex)" :key="idx"></i>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                               <div class="progress">
                                ...
                                <div class="col-md-6">
                                    <div class="row" v-for="r in reviews">
                                        <div class="col-md-4">
                                            <strong class='d-block'>{{ r.user.firsName }} {{ r.user.lastName }}</strong>
                                            <small class='small'>{{ r.createdAt }}</small>
                                ...
                                <Slide v-for="product in related" :key="product.id">
                                    <div class="card me-2">
                                        ...
                                        <div class="card-body p-4">
                                            ...
                                            <strong class='text-danger me-2'>$ {{ parseFloat(product.price).toFixed(2) }}</strong><del><strong class='text-muted'>$ {{ parseFloat(product.priceOld).toFixed(2) }}</strong></del>
