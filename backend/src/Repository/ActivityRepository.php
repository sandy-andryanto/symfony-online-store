...
class ActivityRepository extends ServiceEntityRepository
{
    ...
    public function Create(User $user, string $subject, string $event, string $description)
    {
